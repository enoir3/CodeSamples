#!/usr/bin/python
# This fuzzer is used to test the buffer for bad characters.
# In Immunity Debugger, right click on ESP and select "Follow in Dump"
# Only HEX values that appear in the stack buffer are valid as input
# Scan the dump to find the last char accepted in the string and remove 
# the NEXT character from the bad characters variable below and re-run.
import socket
